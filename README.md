...
[📊 Figure 1](figures/RQ1_Figure_1.pdf) · [📋 Table 1](figures/RQ1_Table_1.pdf)
...
TF-IDF embeddings are computed on real NDC text, and cosine similarity is measured against the global mean mitigation vector.
...
[📊 Figure 2](figures/RQ2_Figure_2.pdf) · [📋 Table 2](figures/RQ2_Table_2.pdf)
...
Claude extracts explicit time-bound commitments from NDC text across three submission rounds (NDC 1.0, 2.0, 3.0) for 7+7+9 countries.
...
[📊 Figure 3](figures/RQ3_Figure_3.pdf) · [📋 Table 3](figures/RQ3_Table_3.pdf)
...
Each NDC is scored on a 0–1 greenwashing risk scale (`0 = substantive`, `1 = performative`) and cross-referenced against verified emissions reduction targets. Pearson r = -0.03 (p = 0.938), indicating no significant correlation.
...
[📊 Figure 4](figures/RQ4_Figure_4.pdf) · [📋 Table 4](figures/RQ4_Table_4.pdf)
...
Lexicon tagging identifies four justice themes across NDC text: Loss & Damage, Intergenerational Equity, Gender Justice, and Indigenous Rights. Spearman rho vs GDP = -0.20 (p = 0.606).
...
[📊 Figure 5](figures/RQ5_Figure_5.pdf) · [📋 Table 5](figures/RQ5_Table_5.pdf)
...
| Dataset | Source | Use |
|---------|--------|-----|
| UNFCCC NDC Registry | [unfccc.int](https://unfccc.int/NDCREG) | Primary — real NDC PDF documents |
| ClimateBERT `climate_specificity` | [HuggingFace](https://huggingface.co/datasets/climatebert/climate_specificity) | Few-shot examples for RQ1 |
...
### Locally
```bash
pip install pdfplumber anthropic datasets scikit-learn matplotlib scipy
